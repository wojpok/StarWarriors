...
namespace StarWarriors.NPCs
{
    public class MyNPC : ModNPC {
        ...
        private static List<Tuple<string, SoundStyle?>> places = [
            new("Mods.StarWarriors.NPCs.MyNPC.StandardDialogue1", null),
        ...
        public override string GetChat()
        {
            ...
            //chat.Add(Language.GetTextValue("Mods.ExampleMod.Dialogue.MyNPC.StandardDialogue1"));
            //chat.Add(Language.GetTextValue("Mods.ExampleMod.Dialogue.MyNPC.StandardDialogue2"));
            //chat.Add(Language.GetTextValue("Mods.ExampleMod.Dialogue.MyNPC.StandardDialogue3"));
            //return chat; // chat is implicitly cast to a string.
            return Language.GetTextValue(places[chosenDialogue].Item1);
        }
        ...
        { // What the chat buttons are when you open up the chat UI
            ...
            button2 = Language.GetTextValue("Mods.StarWarriors.NPCs.MyNPC.Button2");
        }
